...
methodCollection.logHello = function hellog(){
  console.log('hello')
}
...
function makeCard(cardNumber, expirationDate, securityCode){
  ...
  card.exp = expirationDate
  card.secCode = securityCode
  return card
}